...
export default function MiniDrawer(props) {
  ...
  // function onMenuClicked(option) {
  //   switch (option) {
  //     case "CUSTOMERS":
  //       alert("take to customer");
  //       // <Redirect to="/home/admin/customers" />;
  //       break;
  //     case "FACILITIES":
  //       alert("not implemented");
  //       // <Redirect to="/home/admin/facilities" />;
  //       break;
  //     default:
  //       break;
  //   }
    ...
    <div className={classes.root}>
      ...
      >
        ...
        {/* <List>
          ...
          <ListItem button onClick={onMenuClicked("FACILITIES")}>
            <ListItemIcon>
              <InboxIcon />
            </ListItemIcon>
